angular.module("spin.service").factory "Plot", ['$http', 'constant.api', 'constant.settings', 'constant.types', ($http, api, settings, types)->
    new class Plot
        sequenceWrappingObject:
            ...
            hasExit: ->
                this.isPlayer() or this.isDialog() or this.isChoice() or this.isFeedback()
